...
/**
 * TSummary106YcId entity. @author MyEclipse Persistence Tools
 */

public class TSummary106YcId implements java.io.Serializable {
	...
	/** default constructor */
	public TSummary106YcId() {
	}

	/** minimal constructor */
	public TSummary106YcId(Integer id, String targetName, String units,
			String code) {
		this.id = id;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TSummary106YcId))
			return false;
		TSummary106YcId castOther = (TSummary106YcId) other;
