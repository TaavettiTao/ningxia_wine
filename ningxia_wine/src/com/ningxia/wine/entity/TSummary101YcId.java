...
/**
 * TSummary101YcId entity. @author MyEclipse Persistence Tools
 */

public class TSummary101YcId implements java.io.Serializable {
	...
	/** default constructor */
	public TSummary101YcId() {
	}

	/** minimal constructor */
	public TSummary101YcId(Integer id) {
		this.id = id;
	}

	/** full constructor */
	public TSummary101YcId(Integer id, Integer xh, String fieldname,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TSummary101YcId))
			return false;
		TSummary101YcId castOther = (TSummary101YcId) other;
