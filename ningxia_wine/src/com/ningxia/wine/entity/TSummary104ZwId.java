...
/**
 * TSummary104ZwId entity. @author MyEclipse Persistence Tools
 */

public class TSummary104ZwId implements java.io.Serializable {
	...
	/** default constructor */
	public TSummary104ZwId() {
	}

	/** minimal constructor */
	public TSummary104ZwId(Integer productionId, String targetName, String code) {
	...
	/** full constructor */
	public TSummary104ZwId(Integer productionId, String targetName,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TSummary104ZwId))
			return false;
		TSummary104ZwId castOther = (TSummary104ZwId) other;
