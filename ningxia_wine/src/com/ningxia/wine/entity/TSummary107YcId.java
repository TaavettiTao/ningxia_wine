...
/**
 * TSummary107YcId entity. @author MyEclipse Persistence Tools
 */

public class TSummary107YcId implements java.io.Serializable {
	...
	/** default constructor */
	public TSummary107YcId() {
	}

	/** minimal constructor */
	public TSummary107YcId(Integer id, String targetName, String units,
			String code) {
		this.id = id;
	...
	/** full constructor */
	public TSummary107YcId(Integer id, String targetName, String units,
			String code, Double yinchuan, Double xingqingqu, Double xixiaqu,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TSummary107YcId))
			return false;
		TSummary107YcId castOther = (TSummary107YcId) other;
