...
/**
 * TSummary102Id entity. @author MyEclipse Persistence Tools
 */

public class TSummary102Id implements java.io.Serializable {
	...
	/** default constructor */
	public TSummary102Id() {
	}

	/** minimal constructor */
	public TSummary102Id(Integer id) {
		this.id = id;
	}

	/** full constructor */
	public TSummary102Id(Integer id, Integer xh, String targetName,
			String units, String code, Double region, Double yinchuan,
			Double wuzhong, Double shizuishan, Double zhongwei, Double guyuan,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TSummary102Id))
			return false;
		TSummary102Id castOther = (TSummary102Id) other;
