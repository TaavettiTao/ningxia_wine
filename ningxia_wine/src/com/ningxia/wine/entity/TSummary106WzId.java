...
/**
 * TSummary106WzId entity. @author MyEclipse Persistence Tools
 */

public class TSummary106WzId implements java.io.Serializable {
	...
	/** default constructor */
	public TSummary106WzId() {
	}

	/** minimal constructor */
	public TSummary106WzId(Integer id, String targetName, String units,
			String code) {
		this.id = id;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TSummary106WzId))
			return false;
		TSummary106WzId castOther = (TSummary106WzId) other;
