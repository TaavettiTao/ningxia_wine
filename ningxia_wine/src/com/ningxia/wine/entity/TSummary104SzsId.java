...
/**
 * TSummary104SzsId entity. @author MyEclipse Persistence Tools
 */

public class TSummary104SzsId implements java.io.Serializable {
	...
	/** default constructor */
	public TSummary104SzsId() {
	}

	/** minimal constructor */
	public TSummary104SzsId(Integer productionId, String targetName, String code) {
	...
	/** full constructor */
	public TSummary104SzsId(Integer productionId, String targetName,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TSummary104SzsId))
			return false;
		TSummary104SzsId castOther = (TSummary104SzsId) other;
