...
/**
 * TSummary101WzId entity. @author MyEclipse Persistence Tools
 */

public class TSummary101WzId implements java.io.Serializable {
	...
	/** default constructor */
	public TSummary101WzId() {
	}

	/** minimal constructor */
	public TSummary101WzId(Integer id) {
		this.id = id;
	}

	/** full constructor */
	public TSummary101WzId(Integer id, Integer xh, String fieldname,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TSummary101WzId))
			return false;
		TSummary101WzId castOther = (TSummary101WzId) other;
