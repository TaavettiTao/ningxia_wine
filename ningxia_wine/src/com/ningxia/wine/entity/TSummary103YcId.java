...
/**
 * TSummary103YcId entity. @author MyEclipse Persistence Tools
 */

public class TSummary103YcId implements java.io.Serializable {
	...
	/** default constructor */
	public TSummary103YcId() {
	}

	/** minimal constructor */
	public TSummary103YcId(Integer productionId, String targetName, String code) {
	...
	/** full constructor */
	public TSummary103YcId(Integer productionId, String targetName,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TSummary103YcId))
			return false;
		TSummary103YcId castOther = (TSummary103YcId) other;
