...
/**
 * VT201XiangId entity. @author MyEclipse Persistence Tools
 */

public class VT201XiangId implements java.io.Serializable {
	...
	/** full constructor */
	public VT201XiangId(String xqXiangCode, String xqXiangName, Integer gs,
			Double yjcpmj, Double yjjcn, Double zdmj, Double dnjjZzq,
			Double dnjjShi, Double dnjjXian, Double dnjjZje, Double dnbzZzq,
			Double dnbzShi, Double dnbzXian, Double dnbzZje, Integer ygGl,
			Integer ygSc, Integer ygNysc, Integer ygSlg, Integer ygZrs,
			Double gzGlry, Double gzScry, Double gzNysc, Double gzZje) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VT201XiangId))
			return false;
		VT201XiangId castOther = (VT201XiangId) other;

		return ((this.getXqXiangCode() == castOther.getXqXiangCode()) || (this
				.getXqXiangCode() != null && castOther.getXqXiangCode() != null && this
				...
				&& ((this.getGs() == castOther.getGs()) || (this.getGs() != null
						&& castOther.getGs() != null && this.getGs().equals(
						castOther.getGs())))
		...
		result = 37
				* result
				+ (getXqXiangName() == null ? 0 : this.getXqXiangName()
						.hashCode());
		result = 37 * result + (getGs() == null ? 0 : this.getGs().hashCode());
		result = 37 * result
