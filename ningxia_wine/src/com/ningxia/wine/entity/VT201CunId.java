...
/**
 * VT201CunId entity. @author MyEclipse Persistence Tools
 */

public class VT201CunId implements java.io.Serializable {
	...
	/** full constructor */
	public VT201CunId(String xqCunCode, String xqCunName, Integer gs,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof VT201CunId))
			return false;
		VT201CunId castOther = (VT201CunId) other;

		return ((this.getXqCunCode() == castOther.getXqCunCode()) || (this
				.getXqCunCode() != null && castOther.getXqCunCode() != null && this
