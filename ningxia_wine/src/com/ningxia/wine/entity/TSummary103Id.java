...
/**
 * TSummary103Id entity. @author MyEclipse Persistence Tools
 */

public class TSummary103Id implements java.io.Serializable {
	...
	/** default constructor */
	public TSummary103Id() {
	}

	/** minimal constructor */
	public TSummary103Id(Integer id) {
		this.id = id;
	}

	/** full constructor */
	public TSummary103Id(Integer id, String xh, String targetName,
			String units, String code, Double region, Double yinchuan,
			Double shizuishan, Double wuzhong, Double guyuan, Double zhongwei,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TSummary103Id))
			return false;
		TSummary103Id castOther = (TSummary103Id) other;
