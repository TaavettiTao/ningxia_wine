...
/**
 * TSummary106SzsId entity. @author MyEclipse Persistence Tools
 */

public class TSummary106SzsId implements java.io.Serializable {
	...
	/** default constructor */
	public TSummary106SzsId() {
	}

	/** minimal constructor */
	public TSummary106SzsId(Integer id, String targetName, String units,
			String code) {
		this.id = id;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TSummary106SzsId))
			return false;
		TSummary106SzsId castOther = (TSummary106SzsId) other;
