...
/**
 * TSummary103WzId entity. @author MyEclipse Persistence Tools
 */

public class TSummary103WzId implements java.io.Serializable {
	...
	/** default constructor */
	public TSummary103WzId() {
	}

	/** minimal constructor */
	public TSummary103WzId(Integer productionId, String targetName, String code) {
	...
	/** full constructor */
	public TSummary103WzId(Integer productionId, String targetName,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TSummary103WzId))
			return false;
		TSummary103WzId castOther = (TSummary103WzId) other;
